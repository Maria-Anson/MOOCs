...
def random_mini_batches(X, Y, mini_batch_size = 64, seed = 0):
    ...
    if m % mini_batch_size != 0:
        ### START CODE HERE ### (approx. 2 lines)
        mini_batch_X = shuffled_X[:,mini_batch_size*num_complete_minibatches:mini_batch_size*num_complete_minibatches+(m-((mini_batch_size)*math.floor(m/mini_batch_size)))]
        mini_batch_Y = shuffled_Y[:,mini_batch_size*num_complete_minibatches:mini_batch_size*num_complete_minibatches+(m-((mini_batch_size)*math.floor(m/mini_batch_size)))]
        ### END CODE HERE ###
        mini_batch = (mini_batch_X, mini_batch_Y)
        mini_batches.append(mini_batch)
...
def update_parameters_with_momentum(parameters, grads, v, beta, learning_rate):
    ...
    for l in range(L):
        ...
        parameters["b" + str(l+1)] = parameters["W" + str(l + 1)] - learning_rate * v["dW" + str(l + 1)]
        ### END CODE HERE ###
...
```
    ...
    b1 = 
    [[ 1.6265466  -0.61404586 -0.52997493]
     [-1.07397361  0.86360592 -2.30017124]]
    W2 = 
    [[ 0.31930698 -0.24990073  1.4627996 ]
     [-2.05974396 -0.32173003 -0.38320915]
     [ 1.13444069 -1.0998786  -0.1713109 ]]
    b2 = 
    [[ 0.31957487 -0.25043109  1.46349126]
     [-2.0593472  -0.32104286 -0.38236394]
     [ 1.13511193 -1.09986594 -0.17019359]]
    v["dW1"] = 
...
```
    ...
    <ipython-input-108-1adb1253427e> in <module>()
    ...
    <ipython-input-105-ccd037b69098> in model(X, Y, layers_dims, optimizer, learning_rate, mini_batch_size, beta, beta1, beta2, epsilon, num_epochs, print_cost)
         52 
         53             # Forward propagation
    ---> 54             a3, caches = forward_propagation(minibatch_X, parameters)
         55 
         56             # Compute cost and add to the cost total


    /home/jovyan/work/week6/opt_utils_v1a.py in forward_propagation(X, parameters)
        130 
        131     # LINEAR -> RELU -> LINEAR -> RELU -> LINEAR -> SIGMOID
    --> 132     z1 = np.dot(W1, X) + b1
        133     a1 = relu(z1)
        134     z2 = np.dot(W2, a1) + b2


    ValueError: operands could not be broadcast together with shapes (5,64) (5,2) 
