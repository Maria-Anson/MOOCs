...
```
    ...
    <ipython-input-35-0b7e3890788a> in <module>()
         18 
    ...
    <ipython-input-34-b71f0ab5b6e9> in lstm_backward(da, caches)
         52         da_prevt = gradients["da_prev"]
         53         dc_prevt = gradients["dc_prev"]
    ---> 54         dx[:,0,:,t] = gradients["dxt"]
         55         dWf += gradients["dWf"]
         56         dWi += gradients["dWi"]
